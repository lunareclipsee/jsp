...
<body>
	...
	<form id='searchingForm' action="./list.do" method="post" onsubmit="newFnc();">
...
<%-- 		<input type="hidden" id='curPage' name='curPage' value="${pagingMap.memberPaging.curPage}"> --%>
		...
		<input type="text" id="keyword" name="keyword" value="${searchMap.keyword}" placeholder="회원이름 or 이메일 검색">
<%-- 		<input type="hidden" id="keyword2" value="${searchMap.keyword}"> --%>
